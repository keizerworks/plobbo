...
export const DialogOverlay = withCn(
  ...
  "fixed inset-0 z-50 dark:bg-black/80 bg-white/50 backdrop-blur-sm data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0",
);
