...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@plobbo/ui/components/sheet";
import { Skeleton } from "@plobbo/ui/components/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@plobbo/ui/components/tooltip";
import { useIsMobile } from "@plobbo/ui/hooks/use-mobile";
...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden w-[16rem] text-sidebar-foreground md:block"
      data-state={state}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
