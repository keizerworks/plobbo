        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent className="overflow-hidden p-0 sm:max-w-lg">
                <SheetHeader className="border-b px-6 py-4">
                    ...
                    <SheetDescription>
                        Update the metadata for your blog. Make sure all fields
                        are correctly filled before saving.
                    </SheetDescription>
                </SheetHeader>
                        ...
                        <FormField
                            ...
                            render={({ field: { value, ...field } }) => (
                                <TagInput
                                    {...field}
                                    value={
                                        value as unknown as TagInputProps["value"]
                                    }
                                    styleClasses={{
